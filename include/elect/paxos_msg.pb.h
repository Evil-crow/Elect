...
class PaxosMsg PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kAddrFieldNumber = 3,
    kLeaseOwnerFieldNumber = 6,
    kProposalIdFieldNumber = 4,
    kAcceptedProposalIdFieldNumber = 5,
...
inline const std::string& PaxosMsg::addr() const {
  // @@protoc_insertion_point(field_get:elect.PaxosMsg.addr)
  return _internal_addr();
}
inline void PaxosMsg::set_addr(const std::string& value) {
  _internal_set_addr(value);
  // @@protoc_insertion_point(field_set:elect.PaxosMsg.addr)
}
inline std::string* PaxosMsg::mutable_addr() {
  // @@protoc_insertion_point(field_mutable:elect.PaxosMsg.addr)
...
inline void PaxosMsg::set_addr(std::string&& value) {
  ...
  addr_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:elect.PaxosMsg.addr)
}
inline void PaxosMsg::set_addr(const char* value) {
  ...
  addr_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:elect.PaxosMsg.addr)
}
inline void PaxosMsg::set_addr(const char* value,
    size_t size) {
  ...
  addr_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:elect.PaxosMsg.addr)
}
...
inline std::string* PaxosMsg::release_addr() {
  // @@protoc_insertion_point(field_release:elect.PaxosMsg.addr)
...
inline void PaxosMsg::set_allocated_addr(std::string* addr) {
  ...
  addr_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), addr,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:elect.PaxosMsg.addr)
}
inline std::string* PaxosMsg::unsafe_arena_release_addr() {
  // @@protoc_insertion_point(field_unsafe_arena_release:elect.PaxosMsg.addr)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return addr_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void PaxosMsg::unsafe_arena_set_allocated_addr(
    std::string* addr) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (addr != nullptr) {
  ...
  addr_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      addr, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:elect.PaxosMsg.addr)
}
